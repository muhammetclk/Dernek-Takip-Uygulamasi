...
namespace DernekUI
{
    public partial class ListByCity : Form
    {
        ...
        void member_list()
        {
            ...
            {
                dataSet = businessManager.member_list("city_id",cbxCity.Text);
            }

            dgvListCity.DataSource = dataSet.Tables["Members"];
        }

        private void ListByCity_Load(object sender, EventArgs e)
        {
            member_list();
        }

        private void btnListByCity_Click(object sender, EventArgs e)
        {
            member_list();
        }
    }
